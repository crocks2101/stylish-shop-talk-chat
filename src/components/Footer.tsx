    ...
    <footer className="bg-navy text-white py-8 mt-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">MyStore</h3>
            <p className="text-gray-300 text-sm">
              Quality products for your everyday needs. Shop with confidence
              and enjoy our exceptional customer service.
            </p>
          </div>
            ...
            <div className="mt-4">
              ...
              <div className="flex">
                <input 
                  ...
                  className="p-2 text-black rounded-l-md w-full focus:outline-none"
                />
                <button className="bg-primary hover:bg-blue-700 text-white p-2 rounded-r-md transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
